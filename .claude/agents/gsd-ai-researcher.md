...
<required_reading>
Read `/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
