...
<reference>
@/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/references/user-profiling.md` to load:
