...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-ui-checker.md for instructions.
