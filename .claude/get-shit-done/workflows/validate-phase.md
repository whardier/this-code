...
```
Task(
  prompt="Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
1. Read template from `/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/templates/VALIDATION.md`
