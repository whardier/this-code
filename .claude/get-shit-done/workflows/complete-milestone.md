...
```bash
node "/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/templates/retrospective.md`.
