...
```bash
INIT=$(node "/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/templates/spec.md.
