...
<required_reading>
@/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/references/ai-frameworks.md
@/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-framework-selector.md for instructions.
...
```bash
cp "/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/spencersr/src/github/whardier/this-code/.claude/agents/gsd-eval-planner.md for instructions.
