...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs
...
node \"/Users/spencersr/src/github/whardier/this-code/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
